...
- Fixed audio pipeline stability and mid-session UX:
  ...
  - Resolved **VAD Buffer Retention**: fixed a bug where switching from PTT to Always-On would resend the last manual recording by explicitly disabling VAD processing during PTT sessions.
